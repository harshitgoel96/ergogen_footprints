module.exports = {
    ...
    (pad "" np_thru_hole circle (at -5.08 0 ${p.rot}) (size 1.7018 1.7018) (drill 1.7018) (layers *.Cu *.Mask))
    (pad i2 smd rect (at -7.56 -2.54 ${p.rot}) (size 2.55 2.5) (layers B.Cu B.Paste B.Mask) ${p.local_net("1").str})
    (pad "" np_thru_hole circle (at 0 3.7 ${p.rot}) (size 2.3 2.3) (drill 2.3) (layers *.Cu *.Mask))
    (pad i2 thru_hole oval (at 0 5.9 ${p.rot}) (size 2 2.5) (drill oval 1.2 1.75) (layers *.Cu *.Mask) ${p.local_net("1").str})
    ...
    (pad i2 smd roundrect (at -8.509 6.35 ${90 + p.rot}) (size 0.975 1.4) (layers B.Cu B.Paste B.Mask) (roundrect_rratio 0.25) ${p.local_net("1").str})
